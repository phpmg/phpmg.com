      ...
      <div class="row">
        <div class="col-md-10 col-md-offset-2">
          ...
          <div class="social text-right">
            <a href="http://slack.phpmg.com/">
              <img src="img/Microsoft_Messenger-128.png" class="social-medias space-bet hvr-grow"
                   alt="Slack">
            </a>

            <a href="https://www.meetup.com/pt-BR/PHP-MG/">
              <img src="img/meetup-120.png" class="social-medias space-bet hvr-grow"
                   alt="Meetup">
            </a>

            <a href="https://www.facebook.com/elephants.mineiros/?fref=ts">
              <img src="img/197-Facebook-128.png" class="social-medias space-bet hvr-grow"
                   alt="Facebook">
            </a>

            <a href="https://twitter.com/phpmg" class="animated pulse">
              <img src="img/198-Twitter-128.png" class="social-medias hvr-grow"
                   alt="Twitter">
            </a>
          </div>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-8 col-md-6 col-sm-6 col-xs-5">
          <form action="https://pagseguro.uol.com.br/checkout/v2/donation.html" method="post">
            ...
            <input type="hidden" name="receiverEmail" value="juniorgro@gmail.com">
